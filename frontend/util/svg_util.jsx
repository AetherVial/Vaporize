...
export const ff = () => {
    return (
        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
	 width="511.63px" height="511.63px" viewBox="0 0 511.63 511.63" >
    <g>
                <path fill="currentColor" d="M506.203,41.968c-3.617-3.617-7.902-5.426-12.851-5.426H456.81c-4.948,0-9.232,1.809-12.847,5.426
...
export const rw = () => {
    return (
        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px"
	 width="511.633px" height="511.634px" viewBox="0 0 511.633 511.634">
    <g>
        <path fill="currentColor" d="M507.917,36.552c-2.479-1.143-5.523,0.094-9.135,3.709L296.079,242.965c-1.718,1.524-2.957,3.333-3.717,5.424V45.681
...
<g>
	<g>
		<path fill="currentColor" d="M164.453,0H18.276C13.324,0,9.041,1.807,5.425,5.424C1.808,9.04,0.001,13.322,0.001,18.271v401.991
        ...
        <path fill="currentColor" d="M433.113,5.424C429.496,1.807,425.215,0,420.267,0H274.086c-4.949,0-9.237,1.807-12.847,5.424
